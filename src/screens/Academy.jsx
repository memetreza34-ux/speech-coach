...
export const AcademyScreen = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      lessons: [
        { id: "hands-position", title: "Wohin mit den Händen?", duration: "3 Min", type: "video", videoId: "Ks-_Mh1QhMc", content: "Die Grundregel lautet: Hände immer sichtbar halten, idealerweise locker auf Bauchnabelhöhe. Die 'Merkel-Raute' ist ein bekanntes Extrem, zeigt aber die Kernidee: Eine neutrale Ruheposition.\n\nVermeide zwingend verschränkte Arme (Abwehr) oder Hände in den Hosentaschen (Desinteresse).\n\nNutze deine Hände aktiv, um Dimensionen (groß/klein) oder Zahlenstrukturen (Erstens, Zweitens) zu unterstreichen." },
        { id: "power-pose", title: "Die Power Pose (Amy Cuddy)", duration: "4 Min", type: "read", content: "Deine Körperhaltung beeinflusst, wie du dich selbst wahrnimmst.\n\nWenn du dich groß machst (Beine breit, Arme in die Hüften – die 'Wonder Woman' Pose), kannst du dich sicherer und präsenter fühlen.\n\nEine offene Körperhaltung kann sich subjektiv selbstbewusster anfühlen. Starke hormonelle Effekte von Power Posing sind wissenschaftlich nicht zuverlässig belegt, aber es hilft vielen, vor einem wichtigen Gespräch ruhiger zu werden." },
        { id: "eye-contact", title: "Blickkontakt in Videocalls", duration: "2 Min", type: "read", content: "Der größte Fehler in Zoom oder Teams: Du schaust auf die Gesichter der anderen auf deinem Bildschirm.\n\nSchau stattdessen direkt oben in die Kameralinse! Nur wenn du in die Linse schaust, fühlt sich dein Gegenüber wirklich angesehen. Blende zur Not dein eigenes Videobild aus, um nicht ständig dich selbst zu beobachten." },
        { id: "belly-breathing", title: "Bauchatmung gegen Nervosität", duration: "5 Min", type: "read", content: "Atme tief in den Bauch (das Zwerchfell), nicht oben in die Brust.\n\nBrustatmung ist eine Stressreaktion des Körpers und macht deine Stimme dünn und zittrig. Wenn du tief in den Bauch atmest, senkt das deinen Puls sofort und gibt deiner Stimme mehr Volumen, Resonanz und Ruhe." },
        { id: "voice-dynamics", title: "Lautstärkedynamik & Monotonie", practiceMode: "/record/impromptu", duration: "4 Min", type: "video", videoId: "eIho2S0ZahI", content: "Wer monoton spricht, schläfert sein Publikum ein.\n\nDu kannst drei Dinge variieren:\n1. Lautstärke\n2. Sprechtempo\n3. Tonhöhe\n\nWerde ganz leise, um ein 'Geheimnis' zu teilen, und werde etwas lauter und energischer, wenn du deine Kernbotschaft verkündest." }
      ]
    },
    {
    ...
    >
      <div className="max-w-md mx-auto w-full">
        ...
        <div 
          ...
          onClick={() => {
            const storyLesson = categories.flatMap(c => c.lessons).find(l => l.id === 'storytelling-hero-journey');
            if (storyLesson) setSelectedLesson(storyLesson);
